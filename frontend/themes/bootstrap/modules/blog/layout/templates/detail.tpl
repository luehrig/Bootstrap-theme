	...
	{option:item.allow_comments}
		<section id="blogCommentForm" class="mod">
			<div class="inner">
				...
				<div class="bd">
					{option:commentIsInModeration}<div class="alert alert-error">{$msgBlogCommentInModeration}</div>{/option:commentIsInModeration}
					{option:commentIsSpam}<div class="alert alert-info">{$msgBlogCommentIsSpam}</div>{/option:commentIsSpam}
					...
					{form:commentsForm}
						...
						<div class="control-group{option:txtAuthorError} error{/option:txtAuthorError}">
							...
							{$txtAuthor}
							{option:txtAuthorError}<p class="help-block">{$txtAuthorError}</p>{/option:txtAuthorError}
						</div>
						...
						<div class="control-group{option:txtWebsiteError} error{/option:txtWebsiteError}">
							...
							{$txtWebsite}
							{option:txtWebsiteError}<p class="help-block">{$txtWebsiteError}</p>{/option:txtWebsiteError}
						</div>
						...
						<p>
							<input class="btn" type="submit" name="comment" value="{$msgComment|ucfirst}" />
						</p>
					{/form:commentsForm}
				</div>
			</div>
